...
const wowCircle = (
  ...
  return (
    <div className="size-56 2xl:size-96" style={{ top: top }}>
      ...
      <motion.div
        className="size-56 2xl:size-96 flex items-center place-content-center text-tcteal-dark text-5xl 2xl:text-7xl font-extrabold text-center font-['Montserrat'] leading-12 tracking-tighter 2xl:flex overflow-hidden"
